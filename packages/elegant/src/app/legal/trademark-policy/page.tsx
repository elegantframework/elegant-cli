...
export const metadata: Metadata = {
    title: `Trademark Policy - ${process.env.NEXT_PUBLIC_APP_NAME || `Elegant`}`,
...
export default function TrademarkPolicy() {
    return(
        <>
            ...
            <p className="pb-5">
                All trademarks, logos, service marks, and trade names displayed on our website, applications, or other materials ("Marks") are the property of <b>{`${process.env.NEXT_PUBLIC_APP_NAME || `Elegant`}`}</b> or their respective owners. The Marks are protected by trademark laws and international treaties. You may not use any of our Marks without obtaining prior written permission from us or the respective owner, as applicable.
            </p>
            ...
            <p className="pb-5">
                If you become aware of any unauthorized use of our Marks or have any questions regarding their usage, please contact us at <b>{`${process.env.NEXT_PUBLIC_APP_NAME || `Elegant`}`}</b>.
            </p>
