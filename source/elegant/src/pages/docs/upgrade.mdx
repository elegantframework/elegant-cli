...
The upgrade to React 18 and MDX-Loader 2 forced us to convert from the previous excerpt tag format to the new format listed below.<br>
...
This is the new excerpt tag format.
